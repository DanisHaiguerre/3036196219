...
if __name__ == "__main__":
    use_auth_token = "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" # replace "xxx" with your access token (see https://huggingface.co/docs/hub/security-tokens and https://huggingface.co/settings/tokens)

    repo_id = "microsoft/phi-1_5"
    ##repo_id = "microsoft/phi-2"
    local_dir = "/userhome/cs2/jnlyu/localdir/phi-1_5" # replace "xxx" with a real path and make sure that it has at least 3G of space
    ##local_dir = "/userhome/cs2/jnlyu/localdir/phi-2"

    download_from_hf_hub(repo_id=repo_id, use_auth_token=use_auth_token, local_dir=local_dir)


    repo_id = "BAAI/bge-small-en-v1.5"
    local_dir = "/userhome/cs2/jnlyu/localdir/bge-small-en-v1.5"
    download_from_hf_hub(repo_id=repo_id, use_auth_token=use_auth_token, local_dir=local_dir)
